...
if __name__ == "__main__":
    ...
    cols = {"AA": ["plate", "x", "y", "well", "animal_group", "samplename", "miseq_sample_name", "aaanid", "ppid", "pp_set", "spp_id", "total_read_num",
                   "total_umi_num", "merged_r1r2_read_num", "total_aligned_read_num", "aligned_percentage", "wt_aligned_read_num",
    ...
    for f in glob.glob(os.path.join(input, "*.umi_counts.txt")):
        preview.append(os.path.basename(f))
        p.set(os.path.join(pipeline_run_id, os.path.basename(f)), f)
