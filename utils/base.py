...
conn = psycopg2.connect(f"dbname=warehouse user={username} password={password} port=5432 sslmode=verify-ca host={url} keepalives_idle=60000 connect_timeout=6000 keepalives_count=15")
cur = conn.cursor()
