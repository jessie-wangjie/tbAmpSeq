...
conn = psycopg2.connect(f"dbname=warehouse user={username} password={password} port=5432 sslmode=verify-ca host={url} keepalives_idle=6000 connect_timeout=6000")
cur = conn.cursor()
